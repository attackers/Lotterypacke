...
@interface CPAgentTradeRecordVC ()<UIWebViewDelegate,UITextViewDelegate>
{
...
@implementation CPAgentTradeRecordVC
...
- (void)viewDidLoad {
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"CPAgentAmountDetailRecordCell" bundle:nil] forCellReuseIdentifier:NSStringFromClass([CPAgentAmountDetailRecordCell class])];
    ...
    _floatLabel.width = kScreenWidth/3.0f*0.8;
    _floatLabel.originX = kScreenWidth/3.0f*0.1;
...
{
    CPAgentAmountDetailRecordCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([CPAgentAmountDetailRecordCell class])];
...
-(void)queryDataForReferesh
{
    ...
    [SUMRequest startWithDomainString:[CPGlobalDataManager shareGlobalData].domainUrlString
                              apiName:CPSerVerAPINameForAPIAgentAppTradeDetail
