...
@interface CPLotteryShowResultView()
{
...
@implementation CPLotteryShowResultView

static CPLotteryShowResultView *_instance;

+(instancetype)shareInstance
{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _instance = [CPLotteryShowResultView new];
                            ...
                            isList:(BOOL)isList
{
    ...
    switch (resultType) {
        ...
        default:{
            ...
            NSMutableDictionary *markHeightDictionary = isList? [CPLotteryShowResultView shareInstance].markListViewHeightDictionary : [CPLotteryShowResultView shareInstance].markDetailViewHeightDictionary;
